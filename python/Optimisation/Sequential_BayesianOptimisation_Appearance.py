'''
Uses a bayesian optimisation library to perform sequential bayesian optimsation 
regarding the appearance and texture score in the omelette optimisation experiment

A simulation parameter can be used to sanity check and debug the BO system
using guessed functions of how the A+T would depend on the various inputs
